...
"}")
        ...
        self.pushButton_18.setGeometry(QRect(210, 100, 20, 16))
        self.pushButton_18.setLayoutDirection(Qt.LeftToRight)
        self.pushButton_18.setStyleSheet(u"#pushButton_18{\n"
"	border:none;\n"
"}")
        icon15 = QIcon()
        icon15.addFile(u":/res/icon/min.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        icon16 = QIcon()
        icon16.addFile(u":/res/icon/nail.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.pushButton_10.setIcon(icon16)

        self.retranslateUi(Form)
        self.pushButton_9.clicked.connect(Form.close)
        self.pushButton_18.clicked.connect(Form.hide)
